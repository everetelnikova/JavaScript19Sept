...
export declare const proxiedMapperMethods: string[];
/**
...
export declare class Container extends Component {
     ...
     * @since 3.0.0
     */
    _onMapperEvent(name: any, ...args: any[]): void;
    /**
     ...
     * @since 3.0.0
     */
    defineMapper(name?: string | MapperOpts | any, opts?: MapperOpts): Mapper;
    defineResource(name: any, opts: any): Mapper;
    /**
     ...
     * @since 3.0.0
     */
    getMapperByName(name: any): Mapper;
    /**
     ...
     * @since 3.0.0
     */
    count(name: any, query: any, opts?: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    create(name: any, props: any, opts: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    createRecord(name: any, props?: any, opts?: any): any;
    /**
     ...
     * @since 3.0.0
     */
    find(name: any, id: any, opts: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    findAll(name: any, query: any, opts: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    getSchema(name: any): import("./Schema").default;
    /**
     ...
     * @since 3.0.0
     */
    is(name: any, record: any): boolean;
    /**
     ...
     * @since 3.0.0
     */
    sum(name: any, field: any, query: any, opts: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    toJSON(name: any, records: any, opts?: any): any;
    /**
     ...
     */
    update(name: any, id: any, props: any, opts: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    updateMany(name: any, record: any, opts: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    validate(name: any, record: any, opts: any): any[];
}

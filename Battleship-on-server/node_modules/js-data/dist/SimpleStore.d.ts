...
export default class SimpleStore extends Container {
     ...
     */
    _end(name: any, result: any, opts: any): any;
    /**
     ...
     */
    _onCollectionEvent(name: any, ...args: any[]): void;
    /**
     ...
     * @param {object} [opts] Configuration options.
     */
    addToCache(name: any, data: any, opts: any): any;
    /**
     ...
     * @since 3.0.0
     */
    cachedFind: (name: any, hashOrId: any, opts: any) => any;
    /**
     ...
     * @since 3.0.0
     */
    cachedFindAll: (name: any, hashOrId: any, opts: any) => any;
    /**
     ...
     * @since 3.0.0
     */
    cacheFind(name: any, data: any, id: any, opts: any): void;
    /**
     ...
     * @since 3.0.0
     */
    cacheFindAll(name: any, data: any, hash: any, opts: any): void;
    /**
     ...
     * @since 3.0.0
     */
    create(name: any, record: any, opts?: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    createMany(name: any, records: any, opts?: any): Promise<any>;
    ...
    eject(name: any, id: any, opts: any): any;
    ejectAll(name: any, query: any, opts: any): any;
    /**
     ...
     * @since 3.0.0
     */
    find(name: any, id: any, opts?: any): any;
    /**
     ...
     * @since 3.0.0
     */
    findAll(name: any, query: any, opts?: any): any;
    /**
     ...
     * exist.
     */
    getCollection(name: any): Collection;
    /**
     ...
     * @since 3.0.0
     */
    hashQuery(name: any, query: any, opts: any): string;
    inject(name: any, records: any, opts: any): any;
    /**
     ...
     * @since 3.0.0
     */
    remove(name: any, id: any, opts?: any): any;
    /**
     ...
     * @since 3.0.0
     */
    removeAll(name: any, query: any, opts: any): any;
    /**
     ...
     * @since 3.0.0
     */
    removeRelated(name: any, records: any, opts: any): void;
    /**
     ...
     * @since 3.0.0
     */
    update(name: any, id: any, record: any, opts?: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    updateAll(name: any, props: any, query: any, opts?: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    updateMany(name: any, records: any, opts?: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    add(name: any, records: any, opts?: any): any;
    /**
     ...
     * @since 3.0.0
     */
    between(name: any, leftKeys: any, rightKeys: any, opts: any): any;
    /**
     ...
     * @since 3.0.0
     */
    createIndex(name: string | number, indexName: string, fieldList?: string[], opts?: any): void;
    /**
     ...
     * @since 3.0.0
     */
    filter(name: any, queryOrFn?: any, thisArg?: any): any;
    /**
     ...
     * @since 3.0.0
     */
    prune(name: string, opts?: any): any;
    /**
     ...
     * @since 3.0.0
     */
    query(name: any): import("./Query").default;
    /**

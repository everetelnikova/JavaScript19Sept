...
export default class Record extends Settable {
     ...
     * @since 3.0.0
     */
    afterLoadRelations(relations: string[], opts?: any): void;
    /**
     * Lifecycle hook.
     *
     ...
     * @since 3.0.0
     */
    beforeLoadRelations(relations: string[], opts?: any): void;
    /**
    ...
    removeInverseRelation(currentParent: any, id: any, inverseDef: any, idAttribute: any): void;
    setupInverseRelation(record: any, id: any, inverseDef: any, idAttribute: any): void;
    /**
     ...
     * @since 3.0.0
     */
    loadRelations(relations?: string[] | string | any, opts?: any): Promise<this>;
    /**
     ...
     * @since 3.0.0
     */
    set(key: string | any, value?: any, opts?: any): void;
    /**
    ...
    static creatingPath: string;
    static noValidatePath: string;
    static keepChangeHistoryPath: string;
    static previousPath: string;
}
/**

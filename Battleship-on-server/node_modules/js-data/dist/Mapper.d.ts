...
export default class Mapper extends Component {
    ...
    lifecycleMethods: {
        ...
        update: {
            adapterArgs(mapper: any, id: any, props: any, opts: any): any[];
            beforeAssign: number;
            defaults: {}[];
            types: any[];
        };
        updateAll: {
            adapterArgs(mapper: any, props: any, query: any, opts: any): any[];
            beforeAssign: number;
            defaults: {}[];
            types: any[];
        };
        updateMany: {
            adapterArgs(mapper: any, records: any, opts: any): any[];
            beforeAssign: number;
            defaults: {}[];
            types: any[];
        };
     ...
     * @since 3.0.0
     */
    afterCount: (...args: any[]) => Promise<never>;
    /**
     ...
     * @since 3.0.0
     */
    afterCreate: (...args: any[]) => Promise<never>;
    /**
     ...
     * @since 3.0.0
     */
    afterCreateMany: (...args: any[]) => Promise<never>;
    /**
     ...
     * @since 3.0.0
     */
    afterDestroy: (...args: any[]) => Promise<never>;
    /**
     ...
     * @since 3.0.0
     */
    afterDestroyAll: (...args: any[]) => Promise<never>;
    /**
     ...
     * @since 3.0.0
     */
    afterFind: (...args: any[]) => Promise<never>;
    /**
     ...
     * @since 3.0.0
     */
    afterFindAll: (...args: any[]) => Promise<never>;
    /**
     ...
     * @since 3.0.0
     */
    afterSum: (...args: any[]) => Promise<never>;
    /**
     ...
     * @since 3.0.0
     */
    afterUpdate: (...args: any[]) => Promise<never>;
    /**
     ...
     * @since 3.0.0
     */
    afterUpdateAll: (...args: any[]) => Promise<never>;
    /**
     ...
     * @since 3.0.0
     */
    afterUpdateMany: (...args: any[]) => Promise<never>;
    /**
     * Mapper lifecycle hook called by {@link Mapper#create}. If this method
     * returns a promise then {@link Mapper#create} will wait for the promise
     * to resolve before continuing.
     ...
     * @since 3.0.0
     */
    beforeCreate: (...args: any[]) => Promise<never>;
    /**
     * Mapper lifecycle hook called by {@link Mapper#createMany}. If this method
     * returns a promise then {@link Mapper#createMany} will wait for the promise
     * to resolve before continuing.
     ...
     * @since 3.0.0
     */
    beforeCreateMany: (...args: any[]) => Promise<never>;
    /**
     * Mapper lifecycle hook called by {@link Mapper#count}. If this method
     * returns a promise then {@link Mapper#count} will wait for the promise
     * to resolve before continuing.
     ...
     * @since 3.0.0
     */
    beforeCount: (...args: any[]) => Promise<never>;
    /**
     * Mapper lifecycle hook called by {@link Mapper#destroy}. If this method
     * returns a promise then {@link Mapper#destroy} will wait for the promise
     * to resolve before continuing.
     ...
     * @since 3.0.0
     */
    beforeDestroy: (...args: any[]) => Promise<never>;
    /**
     * Mapper lifecycle hook called by {@link Mapper#destroyAll}. If this method
     * returns a promise then {@link Mapper#destroyAll} will wait for the promise
     * to resolve before continuing.
     ...
     * @since 3.0.0
     */
    beforeDestroyAll: (...args: any[]) => Promise<never>;
    /**
     ...
     * @since 3.0.0
     */
    beforeFind: (...args: any[]) => Promise<never>;
    /**
     * Mapper lifecycle hook called by {@link Mapper#findAll}. If this method
     * returns a promise then {@link Mapper#findAll} will wait for the promise
     * to resolve before continuing.
     ...
     * @since 3.0.0
     */
    beforeFindAll: (...args: any[]) => Promise<never>;
    /**
     * Mapper lifecycle hook called by {@link Mapper#sum}. If this method
     * returns a promise then {@link Mapper#sum} will wait for the promise
     * to resolve before continuing.
     ...
     * @since 3.0.0
     */
    beforeSum: (...args: any[]) => Promise<never>;
    /**
     * Mapper lifecycle hook called by {@link Mapper#update}. If this method
     * returns a promise then {@link Mapper#update} will wait for the promise
     * to resolve before continuing.
     ...
     * @since 3.0.0
     */
    beforeUpdate: (...args: any[]) => Promise<never>;
    /**
     * Mapper lifecycle hook called by {@link Mapper#updateAll}. If this method
     * returns a promise then {@link Mapper#updateAll} will wait for the promise
     * to resolve before continuing.
     ...
     * @since 3.0.0
     */
    beforeUpdateAll: (...args: any[]) => Promise<never>;
    /**
     * Mapper lifecycle hook called by {@link Mapper#updateMany}. If this method
     * returns a promise then {@link Mapper#updateMany} will wait for the promise
     * to resolve before continuing.
     ...
     * @since 3.0.0
     */
    beforeUpdateMany: (...args: any[]) => Promise<never>;
    /**
    ...
    _commitChanges(recordOrRecords: any, newValues: any): any;
    /**
     ...
     * @since 3.0.0
     */
    _createParentRecordIfRequired(props: any, opts: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    _createOrAssignChildRecordIfRequired(props: any, context: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    createRecord(props?: any, opts?: any): Record | Record[] | any;
    /**
     ...
     * @tutorial ["http://www.js-data.io/v3.0/docs/connecting-to-a-data-source","Connecting to a data source"]
     */
    registerAdapter(name: any, adapter: any, opts?: any): void;
    _runHook(hookName: any, ...hookArgs: any[]): Promise<any>;
    _invokeAdapterMethod(method: any, propsOrRecords: any, opts: any): any;
    /**
     ...
     * @since 3.0.0
     */
    sum(field: any, query: QueryDefinition, opts?: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    toJSON(records: any, opts?: any): any;
    /**
     ...
     * @tutorial ["http://www.js-data.io/v3.0/docs/saving-data","Saving data"]
     */
    update(id: any, props: any, opts?: any): Promise<any>;
    /**
     ...
     * @tutorial ["http://www.js-data.io/v3.0/docs/saving-data","Saving data"]
     */
    updateAll(props: any, query?: QueryDefinition, opts?: any): Promise<any>;
    /**
     ...
     * @since 3.0.0
     */
    validate(record: any, opts?: any): any[];
    /**
     ...
     * @since 3.0.0
     */
    wrap(data: any, opts: any): any;
    /**
     * @ignore
     */
    defineRelations(): void;
}
/**
